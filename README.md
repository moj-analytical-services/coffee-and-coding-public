...
* Name folders as follows: NAME OF PRESENTATION_DD-MM-YYYY
...
Tues 16th April 2019|14:00|2.19 (10SC)|Deriving Demographic Information using R|Rachel Forty|Improving understanding of the demographic mix of current and historic datasets is vital in developing more effective court services. However, many datasets do not include demographic information, such as gender. In this talk we will detail an approach to deriving gender from forenames and the results across multiple datasets, focusing on successes, limitations, and possible extensions. The talk will also look at how the project was adapted to perform quickly in R.|
