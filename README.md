...
---------------|-----|-----|------------|------------------|------------------------------------
Tuesday 17th September 2019 | 15:00 | 7.29B (102PF) | Introduction to Python II | Karik Isichei | Continuing on from Karik's previous session on Python earlier this montb. 
