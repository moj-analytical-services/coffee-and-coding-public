...
---------------|-----|-----|------------|------------------|------------------------------------
Thursday 7th November 2019 | 14:00 | Conf 12 (102PF) | Rapid Data Visualisation with R | Bill Cockerill | This coffee & code aims to give you several simple R code methods you can use straight away to more rapidly explore data visually with fewer confusing error messages. For each simple example further code is demonstrated that can turn a quick exploration into publication ready plots.
